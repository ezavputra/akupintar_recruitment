 ...
 * Generated for Laravel 5.3.31 on 2021-04-13 16:30:25.
 *
...
namespace Kawankoding\Fcm { 
    ...
    class FcmFacade {
        ...
        {
            return \Kawankoding\Fcm\Fcm::to($recipients);
        }
         ...
         * @static 
         */ 
        public static function toTopic($topic)
        {
            return \Kawankoding\Fcm\Fcm::toTopic($topic);
        }
        ...
        {
            return \Kawankoding\Fcm\Fcm::data($data);
        }
         ...
         * @static 
         */ 
        public static function notification($notification = array())
        {
            return \Kawankoding\Fcm\Fcm::notification($notification);
        }
        ...
        {
            return \Kawankoding\Fcm\Fcm::priority($priority);
        }
         ...
         * @static 
         */ 
        public static function timeToLive($timeToLive)
        {
            return \Kawankoding\Fcm\Fcm::timeToLive($timeToLive);
        }
        ...
        {
            return \Kawankoding\Fcm\Fcm::send();
        }
...
namespace  { 
    ...
    class Fcm extends \Kawankoding\Fcm\FcmFacade {}
